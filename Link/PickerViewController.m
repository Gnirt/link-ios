...
- (void)viewDidLoad
{
    ...
    // Initialize Data
    _pickerData = [@[@"Albert Confucius", @"Jeanne d'Arc", @"Samantha", @"Sophie Favier", @"Martin Luther King", @"Jesus Christ", @"Max", @"Bernard Boudha", @"Nelson Mandela", @"Rosa Parks", @"Joseph Socrates", @"Mohammed Ali", @"Gandhi", @"Tim Berners Lee"]sortedArrayUsingSelector:@selector(localizedCaseInsensitiveCompare:)];
